    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Docs&Drugs, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Docs&Drugs, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Docs&Drugs is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© Docs&Drugs. All rights reserved.</p>
      </div>
    </div>
  );
}
